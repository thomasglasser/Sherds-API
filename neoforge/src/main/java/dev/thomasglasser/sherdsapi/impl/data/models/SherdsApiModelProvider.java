...
public class SherdsApiModelProvider extends ModelProvider {
    public SherdsApiModelProvider(PackOutput output) {
        super(output, SherdsApiConstants.MOD_ID);
    }

    @Override
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        itemModels.itemModelOutput.accept(Items.DECORATED_POT, ItemModelUtils.conditional(
